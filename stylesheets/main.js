...
$.ajax({
  type : 'POST', 
  url : '/student/allStatus', //gửi dữ liệu sang trang data.php
  success: function(json){
    ...
    for(var i=data.length-1;i>-1;i--){
      ...
      <div class="col-md-12 contentBox">
        <div class="userInfor">
          <div class="infor">
            <div class="userName"><h4>${data[i].email}</h4></div></a>
            <div class="titlePost"><h4>${data[i].titlePost}</h4></div></a>
          </div>
        </div>
        <div class="context">
            <div class="contextPost">${data[i].contextPost}</div>
            <img src="data:image/png;base64," alt="">
        </div>  
        </div>  
      `)
